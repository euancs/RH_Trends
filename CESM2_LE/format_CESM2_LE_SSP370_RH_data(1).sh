...
calc_RH_vals() {
    ...
    # Zonal
    ncra -O --mro -d time,"2016-01-01","2100-03-01",12,3 "$file_name"201501-210012_zonal_mean.nc "$file_name"2015-2100_DJF_zonal_mean.nc
    ...
    # Tropical
    ncra -O --mro -d time,"2016-01-01","2100-03-01",12,3 "$file_name"201501-210012_tropical_mean.nc "$file_name"2015-2100_DJF_tropical_mean.nc
    ...
    # East Pacific
    ncra -O --mro -d time,"2016-01-01","2100-03-01",12,3 "$file_name"201501-210012_EP_mean.nc "$file_name"2015-2100_DJF_EP_mean.nc
